-- Remove the foreign key constraint from auction_items.seller_id
-- This allows us to create test data without needing actual users
ALTER TABLE auction_items DROP CONSTRAINT IF EXISTS auction_items_seller_id_fkey;

-- Insert some test auction items
