          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {(formData.saleType === 'buy-now' || formData.saleType === 'both') && (
                  <div className="space-y-2">
                    <Label htmlFor="buyNowPrice">Buy Now Price ($)</Label>
                    <Input id="buyNowPrice" type="number" placeholder="99.99" value={formData.buyNowPrice} onChange={(e) => setFormData({ ...formData, buyNowPrice: e.target.value })} required={formData.saleType === 'buy-now' || formData.saleType === 'both'} />
                  </div>
                )}
              </div>
