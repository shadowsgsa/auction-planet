...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess(`Account created successfully! Please check your email (${formData.email}) for a verification link. You may need to check your spam folder.`);
      // Reset form
      setFormData({
        firstName: '',
        lastName: '',
    ...
    <div className="min-h-screen bg-muted/30 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Join Auction Planet</CardTitle>
          <CardDescription>
              ...
              >
                <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                  ...
                  <Label htmlFor="buyer" className="flex items-center cursor-pointer flex-1">
                    <ShoppingBag className="mr-2 h-4 w-4 text-success" />
                    <div>
                      <div className="font-medium">Buy items</div>
                      <div className="text-sm text-muted-foreground">Browse, bid, and purchase</div>
                    </div>
                  </Label>
                </div>
                <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                  ...
                  <Label htmlFor="seller" className="flex items-center cursor-pointer flex-1">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">List items for auction or place bids</div>
                    </div>
                  </Label>
                </div>
                <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                  ...
                  <Label htmlFor="both" className="flex items-center cursor-pointer flex-1">
                    ...
                    <div>
                      <div className="font-medium">Both: Buy & Sell</div>
                      <div className="text-sm text-muted-foreground">Full access to buying and selling</div>
                    </div>
                  </Label>
                </div>
              </RadioGroup>
